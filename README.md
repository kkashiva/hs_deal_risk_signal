...
### 1. Daily Scheduled Risk Scan (`/api/cron/risk-scan`)
...
* Summary metrics (Total Scanned, High/Medium/Low Risk counts).
* A sortable table of all evaluated deals.
* **Client-side filtering** by Pipeline, Risk Level, Primary Risk, and Deal Amount (Min/Max).
